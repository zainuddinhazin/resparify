...
class Question {
  ...
  Question(this.questionText, this.answerText01, this.answerText02,
      this.answerText03, this.answerText04, this.correctAnswer);
  ...
  String getRealAnswer(context) {
    switch (correctAnswer) {
      ...
      default: // this can happen if the question answer is not set correctly
        return 'I guess something went wrong. None of the answers are marked as correct. \uD83D\uDE48';
    }
  }
